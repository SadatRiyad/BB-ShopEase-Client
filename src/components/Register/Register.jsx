...
const Register = () => {
    ...
    return (
        <div className="p-8 md:px-20 min-h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-red-500">
            <Helmet>
                <title>Register | BB-ShopEase</title>
            </Helmet>
            <Card className="mx-auto max-w-sm">
                <CardHeader className="text-center">
                    <CardTitle className="text-2xl text-customBlue">Register to BB-ShopEase</CardTitle>
                    <CardDescription>
                ...
                <CardContent>
                    <div className="grid gap-4">
                        <form onSubmit={handleSubmit(onSubmit)} >
                            ...
                            <div className="grid gap-2 form-control mb-2 mt-4">
                                <Label htmlFor="photoURL" className="text-left">Photo URL</Label>
