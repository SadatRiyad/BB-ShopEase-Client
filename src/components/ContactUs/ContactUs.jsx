...
const ContactUs = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Contact Us | BB-ShopEase</title>
            </Helmet>
            <div className="container mx-auto px-0 pt-8 pb-6" id='contactUs'>

                <div className="py-8 pt-16 bg-customGulabi rounded-b-xl mb-1 -mt-8 text-white">
                ...
                <div id="support" className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center px-8 py-16 bg-customGulabi rounded-xl">
